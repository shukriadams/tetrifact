...
argParser.add_argument('--package_count', type=int, default=3)
argParser.add_argument('--package_file_count_min', type=int, default=1)
argParser.add_argument('--package_file_count_max', type=int, default=100)
argParser.add_argument('--segment_count_min', type=int, default=1)
argParser.add_argument('--segment_count_max', type=int, default=10)
argParser.add_argument('--file_size_min', type=int, default=1)
argParser.add_argument('--file_size_max', type=int, default=10000000)
argParser.add_argument('--file_reuse_chance', type=int, default=50)
