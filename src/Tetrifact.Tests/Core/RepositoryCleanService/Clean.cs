...
namespace Tetrifact.Tests.repositoryCleaner
{
    ...
    public class Clean : FileSystemBase
    {
        ...
        public void Clean_Locked_System()
        {
            ...
            RepositoryCleanService respositoryCleaner = new RepositoryCleanService(mockIndexReader, new TestMemoryCache(), NinjectHelper.Get<ILock>(), SettingsHelper.CurrentSettingsContext, this.DirectoryFs, this.FileFs, RepoCleanLog);
        ...
        public void Clean_Unhandled_Exception()
        {
            ...
            RepositoryCleanService mockedCleaner = new RepositoryCleanService(mockIndexReader, new TestMemoryCache(), NinjectHelper.Get<ILock>(), SettingsHelper.CurrentSettingsContext, this.DirectoryFs, this.FileFs, RepoCleanLog);
