...
namespace Tetrifact.Tests.IndexReader
{
    ...
    public class InitializeTemp
    {
        ...
        public void Wipe()
        {
            ...
            Core.IIndexReader reader = new Core.IndexReader(settings, tagService, new TestLogger<Core.IIndexReader>(), new FileWrapper(new FileSystem()), HashServiceHelper.Instance());
            reader.Initialize();
