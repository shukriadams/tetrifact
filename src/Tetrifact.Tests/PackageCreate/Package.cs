...
namespace Tetrifact.Tests.Controllers
{
    public class Package : TestBase
    {
        ...
        public void AddPackageAsFiles()
        {
            ...
            string expectedFullhash = Core.HashService.FromString(
                Core.HashService.FromString("folder1/file1.txt") +
                Core.HashService.FromString(file1Content) +
                Core.HashService.FromString("folder2/file2.txt") +
                Core.HashService.FromString(file2Content));
