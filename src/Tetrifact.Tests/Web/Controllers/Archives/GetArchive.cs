...
namespace Tetrifact.Tests.Controllers.Archives
{
    public class GetArchive: TestBase
    {
        ...
        public void Happy_path()
        {
            ...
            FileStreamResult result = controller.GetArchive("any-package-id", "my-ticket", "my_waiver") as FileStreamResult;
        ...
        public void Handle_404()
        {
            ...
            NotFoundObjectResult result = controller.GetArchive("any-package-id", "my-ticket", "my_waiver") as NotFoundObjectResult;
            Assert.NotNull(result);
        }
        ...
        public void Handle_500()
        {
            ...
            BadRequestObjectResult result = controller.GetArchive("any-package-id", "my-ticket", "my_waiver") as BadRequestObjectResult;
            Assert.NotNull(result);
        }
    }
}
